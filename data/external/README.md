...
| `sih_ano_lesoes_sp.csv`, `sih_ano_sintomas_sp.csv`, `sih_ano_tmentais_sp.csv` | ✅ já temos — TabNet **por local de residência**, com quebra por ano, Jan/2022-Jul/2026, um por capítulo CID-10 (ver `FONTES_RIO_CLARO.md`) | Notebook 02 (caminho principal, já testado) |
| `sih_residencia_*.csv` | ⚠️ **superados** — mesma consulta, mas só o total do período, sem quebra por ano | nenhum notebook lê mais |
